...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'battleship.command.game' => 'getBattleship_Command_GameService',
            'battleship.factory.boat' => 'getBattleship_Factory_BoatService',
            'battleship.factory.grid' => 'getBattleship_Factory_GridService',
            'battleship.restriction.boat' => 'getBattleship_Restriction_BoatService',
            'battleship.service.console_logger' => 'getBattleship_Service_ConsoleLoggerService',
            'battleship.service.direction' => 'getBattleship_Service_DirectionService',
            'battleship.service.grid' => 'getBattleship_Service_GridService',
            'battleship.service.initialization_game' => 'getBattleship_Service_InitializationGameService',
            'battleship.service.position' => 'getBattleship_Service_PositionService',
            'battleship.service.user_communication.console' => 'getBattleship_Service_UserCommunication_ConsoleService',
            'battleship.transformer.column' => 'getBattleship_Transformer_ColumnService',
            'battleship.transformer.row' => 'getBattleship_Transformer_RowService',
        ...
        $this->aliases = array(
            'console.command.battleshipbundle_command_gamecommand' => 'battleship.command.game',
    ...
    /**
     * Gets the 'battleship.command.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Command\GameCommand A BattleshipBundle\Command\GameCommand instance.
     */
    protected function getBattleship_Command_GameService()
    {
        return $this->services['battleship.command.game'] = new \BattleshipBundle\Command\GameCommand($this->get('battleship.factory.boat'), $this->get('battleship.restriction.boat'), $this->get('battleship.factory.grid'), $this->get('battleship.service.user_communication.console'), $this->get('battleship.service.initialization_game'), $this->get('battleship.service.console_logger'));
    }

    /**
     * Gets the 'battleship.factory.boat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Factory\BoatFactory A BattleshipBundle\Factory\BoatFactory instance.
     */
    protected function getBattleship_Factory_BoatService()
    {
        return $this->services['battleship.factory.boat'] = new \BattleshipBundle\Factory\BoatFactory($this->get('battleship.restriction.boat'));
    }

    /**
     * Gets the 'battleship.factory.grid' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Factory\GridFactory A BattleshipBundle\Factory\GridFactory instance.
     */
    protected function getBattleship_Factory_GridService()
    {
        return $this->services['battleship.factory.grid'] = new \BattleshipBundle\Factory\GridFactory();
    }

    /**
     * Gets the 'battleship.restriction.boat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Restriction\BoatRestriction A BattleshipBundle\Restriction\BoatRestriction instance.
     */
    protected function getBattleship_Restriction_BoatService()
    {
        return $this->services['battleship.restriction.boat'] = new \BattleshipBundle\Restriction\BoatRestriction();
    }

    /**
     * Gets the 'battleship.service.console_logger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Logger\ConsoleLogger A BattleshipBundle\Logger\ConsoleLogger instance.
     */
    protected function getBattleship_Service_ConsoleLoggerService()
    {
        return $this->services['battleship.service.console_logger'] = new \BattleshipBundle\Logger\ConsoleLogger();
    }

    /**
     * Gets the 'battleship.service.direction' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Service\DirectionService A BattleshipBundle\Service\DirectionService instance.
     */
    protected function getBattleship_Service_DirectionService()
    {
        return $this->services['battleship.service.direction'] = new \BattleshipBundle\Service\DirectionService();
    }

    /**
     * Gets the 'battleship.service.grid' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Service\GridService A BattleshipBundle\Service\GridService instance.
     */
    protected function getBattleship_Service_GridService()
    {
        return $this->services['battleship.service.grid'] = new \BattleshipBundle\Service\GridService();
    }

    /**
     * Gets the 'battleship.service.initialization_game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Service\InitializationGameService A BattleshipBundle\Service\InitializationGameService instance.
     */
    protected function getBattleship_Service_InitializationGameService()
    {
        return $this->services['battleship.service.initialization_game'] = new \BattleshipBundle\Service\InitializationGameService($this->get('battleship.service.user_communication.console'), $this->get('battleship.service.position'), $this->get('battleship.service.grid'), $this->get('battleship.service.console_logger'));
    }

    /**
     * Gets the 'battleship.service.position' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Service\PositionService A BattleshipBundle\Service\PositionService instance.
     */
    protected function getBattleship_Service_PositionService()
    {
        return $this->services['battleship.service.position'] = new \BattleshipBundle\Service\PositionService($this->get('battleship.service.direction'));
    }

    /**
     * Gets the 'battleship.service.user_communication.console' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Service\ConsoleUserCommunication A BattleshipBundle\Service\ConsoleUserCommunication instance.
     */
    protected function getBattleship_Service_UserCommunication_ConsoleService()
    {
        return $this->services['battleship.service.user_communication.console'] = new \BattleshipBundle\Service\ConsoleUserCommunication($this->get('battleship.restriction.boat'), $this->get('battleship.transformer.column'), $this->get('battleship.transformer.row'), $this->get('battleship.service.direction'));
    }

    /**
     * Gets the 'battleship.transformer.column' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Transformer\ColumnTransformer A BattleshipBundle\Transformer\ColumnTransformer instance.
     */
    protected function getBattleship_Transformer_ColumnService()
    {
        return $this->services['battleship.transformer.column'] = new \BattleshipBundle\Transformer\ColumnTransformer();
    }

    /**
     * Gets the 'battleship.transformer.row' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BattleshipBundle\Transformer\RowTransformer A BattleshipBundle\Transformer\RowTransformer instance.
     */
    protected function getBattleship_Transformer_RowService()
    {
        return $this->services['battleship.transformer.row'] = new \BattleshipBundle\Transformer\RowTransformer();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4c8c8593a5376a1847eb1481521d04a21607a97d08c133951c35ee6fb48a1f71');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('19e497ce14e17a9700937082685224ffbe7935b1');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('573d163c5f1d37.92849568')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BattleshipBundle' => 'BattleshipBundle\\BattleshipBundle',
            ...
            'secret' => '19e497ce14e17a9700937082685224ffbe7935b1',
            'locale' => 'en',
            ...
            'kernel.secret' => '19e497ce14e17a9700937082685224ffbe7935b1',
