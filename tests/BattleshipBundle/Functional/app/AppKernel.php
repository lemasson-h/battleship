<?php
namespace Tests\BattleshipBundle\Functional\app;

// get the autoload file
$reflectionAppKernel = new \ReflectionClass(\Symfony\Bundle\FrameworkBundle\Tests\Functional\app\AppKernel::class);
$dir = dirname($reflectionAppKernel->getFileName());
$lastDir = null;
while ($dir !== $lastDir) {
    $lastDir = $dir;
